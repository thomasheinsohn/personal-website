...
const variantStyles = {
  solid: {
    ...
    blue: 'bg-blue-950 text-white hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-950 active:bg-blue-900 active:text-white/80 disabled:opacity-30 disabled:hover:bg-blue-950',
    white:
  ...
  outline: {
    ...
    blue: 'border-blue-300 text-blue-950 hover:border-blue-400 hover:bg-blue-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-950 active:text-blue-950/70 disabled:opacity-40 disabled:hover:border-blue-300 disabled:hover:bg-transparent',
  },
}
